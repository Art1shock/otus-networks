...
Все это было сделано. Вывод команды **show vlan brief** для каждого коммутатора был показан выше, все назначено в соответствии с таблицей. Также добавил VLAN 1000 под названием Custom для каждого уоммутатора:
