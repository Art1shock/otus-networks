...
Никаких новых адресов не появилось.
...
Появилось 3 новых IP-адреса. Указаны все адреса сети, кроме одного - компьютера PC-B, с которого отправлялись эхо-запросы.
