...
![](https://github.com/Art1shock/images/blob/main/%D0%A1%D0%BA%D1%80%D0%B8%D0%BD%D1%8B%20%D0%B4%D0%BB%D1%8F%20%D0%94%D0%97_10/Screenshot_34.png)
...
Потому что в сети 10.53.0.0 есть 2 коммутатора подключенные через Fast Ethernet (100 Мбит/с), соответственно стоимость максимум будет равна 1. А в сети 192.168.1.0 максимальная пропускная способность 1000 Мбит/с, но она была снижена до 500 Мбит/с, поэтому стоимость для этой сети равна 5.
