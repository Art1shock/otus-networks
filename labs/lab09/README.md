...
Так как изменилась пропускная способность маршрутизаторов с 1000 Мбит/с на 500 Мбит/с и к тому же чтобы "дойти" до этой сети (192.168.1.0/24) нужно пройти коммутаторы скорость интерфейсов у которых 100 Мбит/с. Отсюда и получается, что стоимость равна не 1, а 5.
